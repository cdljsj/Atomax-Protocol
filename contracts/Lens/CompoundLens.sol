...
contract CompoundLens {
    ...
    function cTokenUnderlyingPriceAll(CToken[] calldata cTokens) view external returns (CTokenUnderlyingPrice[] memory) {
        uint cTokenCount = cTokens.length;
    ...
    function getAccountLimits(ComptrollerLensInterface comptroller, address account) view public returns (AccountLimits memory) {
